...
// import { FaUser, FaCog, FaBell, FaShieldAlt, FaBox } from 'react-icons/fa'; // Import FaBox here

// function Cl() {
//   const navigate = useNavigate(); // Initialize navigation
//   const [lowStockItems, setLowStockItems] = useState([]); // State for low stock items
//   const [items, setItems] = useState([]); // State for all items (replace with API data)

//   useEffect(() => {
//     // Fetch or simulate items data
//     const fetchItems = () => {
//       const items = [
//         { item_name: 'Item 1', quantity: 10 },
//         { item_name: 'Item 2', quantity: 2 },
//         { item_name: 'Item 3', quantity: 8 },
//       ];

//       // Set the items data
//       setItems(items);

//       // Filter low stock items (e.g., quantity <= 5)
//       const lowStock = items.filter((item) => item.quantity <= 5);
//       setLowStockItems(lowStock);
//     };

//     fetchItems(); // Fetch items on initial render
//   }, []); // Empty dependency array to run only once

//   // Handle notification icon click
//   const handleNotificationClick = () => {
//     navigate('/notify'); // Navigate to the Notification page
//   };
...
//           <ItemList items={items} /> {/* Passing items to ItemList */}
//         </div>
//       </div>

//       {/* Sidebar */}
//       <div className="fixed top-0 left-0 w-48 bg-teal-600 text-white p-6 rounded-md shadow-lg z-10 h-screen overflow-y-auto">
//         <div className="mb-6">
...
//           </li>
//           <li>
//             <button onClick={handleNotificationClick} className="flex items-center hover:text-teal-300 w-full">
//               <FaBell className="mr-2 relative">
...
//           <li>
//             <button onClick={() => navigate('/report')} className="flex items-center hover:text-teal-300 w-full">
//               <FaShieldAlt className="mr-2" /> Reports
//             </button>
//           </li>
//           {/* Navigate to Clerk Page */}
//           <li>
//             <button onClick={() => navigate('/clerk')} className="flex items-center hover:text-teal-300 w-full">
//               <FaBox className="mr-2" /> Clerk {/* FaBox Icon */}
//             </button>
//           </li>
//         </ul>
//       </div>
...
//       {/* Header Section */}
//       <div className="bg-teal-500 text-white py-6 shadow-md">
//         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//           <h1 className="text-2xl md:text-3xl font-bold">Welcome, Clerk!</h1>
//           <p className="mt-2 text-sm md:text-base">Manage your inventory efficiently</p>
//         </div>
...
//           }`}
//         >
//           <div className="mb-6 mt-20"> {/* mt-20 pushes content below header */}
...
//             </li>
//             <li>
//               <button onClick={handleNotificationClick} className="flex items-center hover:text-green-900 w-full transition-colors duration-200">
//                 <FaBell className="mr-2 relative">
//                   {lowStockItems.length > 0 && (
//                     <span className="absolute top-0 right-0 w-2.5 h-2.5 bg-red-500 rounded-full"></span>
//                   )}
...
function Cl() {
  ...
  useEffect(() => {
    const fetchItems = () => {
      const initialItems = [
        { item_id: '1', item_name: 'Item 1', quantity: 10 },
        { item_id: '3', item_name: 'Item 3', quantity: 8 },
      ];
      setItems(initialItems);
      const lowStock = initialItems.filter((item) => item.quantity < 5);
      setLowStockItems(lowStock);
      setLastUpdated(new Date().toLocaleString());
      console.log('Initial items:', initialItems);
      console.log('Initial lowStockItems:', lowStock);
    };
